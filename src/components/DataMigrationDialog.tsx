...
const MIGRATION_TEMPLATES = {
  clients: {
    ...
    required: ["name"],
    aliases: {
      name: ["nome", "cliente", "razao_social", "razão social", "nome_fantasia", "Nome", "Cliente", "NOME", "CLIENTE", "Nome do Cliente", "Nome Cliente", "RAZAO SOCIAL", "Razao Social", "Nome Fantasia", "NOME FANTASIA", "Nome/Razão Social", "Cliente/Fornecedor"],
      email: ["e-mail", "e_mail", "correio", "Email", "E-mail", "EMAIL", "E-MAIL", "Correio Eletrônico", "email_cliente", "e mail"],
      phone: ["telefone", "tel", "celular", "fone", "Telefone", "Celular", "TELEFONE", "CELULAR", "Fone", "Tel", "TEL", "contato", "Contato", "CONTATO", "Telefone/Celular", "Whatsapp", "WHATSAPP"],
      cpf: ["CPF", "documento_cpf", "CPF/CNPJ", "Documento", "cpf_cnpj", "CPF_CNPJ", "Doc", "DOC", "Nº Documento", "Documento CPF"],
      cnpj: ["CNPJ", "documento_cnpj", "Documento CNPJ"],
      company_name: ["razao_social", "razão social", "empresa", "Razão Social", "Empresa", "RAZÃO SOCIAL", "RAZAO SOCIAL", "Razao Social", "Nome Empresa", "EMPRESA", "Fantasia", "FANTASIA"],
      address: ["endereco", "endereço", "logradouro", "Endereço", "Endereco", "ENDEREÇO", "ENDERECO", "Logradouro", "LOGRADOURO", "Rua", "RUA", "Endereço Completo"],
      city: ["cidade", "municipio", "município", "Cidade", "CIDADE", "Município", "MUNICIPIO", "Municipio"],
      state: ["estado", "uf", "UF", "Estado", "ESTADO", "Uf"],
      zipcode: ["cep", "CEP", "codigo_postal", "Cep", "Código Postal", "CODIGO POSTAL", "Cod Postal"],
      notes: ["observacoes", "observações", "obs", "Observações", "OBS", "Observacao", "Observação", "OBSERVACOES", "OBSERVAÇÕES", "Notas", "NOTAS"],
    }
  },
  suppliers: {
    name: "Fornecedores",
    ...
    required: ["name"],
    aliases: {
      name: ["nome", "fornecedor", "razao_social", "razão social", "Nome", "Fornecedor", "NOME", "FORNECEDOR", "RAZAO SOCIAL", "Razao Social", "Nome/Razão Social", "Nome Fantasia"],
      email: ["e-mail", "e_mail", "correio", "Email", "E-mail", "EMAIL", "E-MAIL", "email_fornecedor"],
      phone: ["telefone", "tel", "celular", "fone", "Telefone", "Celular", "TELEFONE", "CELULAR", "Contato", "CONTATO", "Whatsapp"],
      cpf: ["CPF", "documento_cpf", "CPF/CNPJ", "Doc", "DOC", "Documento"],
      cnpj: ["CNPJ", "documento_cnpj", "Documento CNPJ"],
      company_name: ["razao_social", "razão social", "empresa", "Razão Social", "Empresa", "RAZAO SOCIAL", "Fantasia"],
      address: ["endereco", "endereço", "logradouro", "Endereço", "ENDEREÇO", "ENDERECO", "Logradouro", "Rua"],
      ...
      notes: ["observacoes", "observações", "obs", "Observações", "OBS", "OBSERVACOES", "Notas"],
    }
  },
  products: {
    name: "Produtos",
    ...
    required: ["name"],
    aliases: {
      name: ["nome", "produto", "Nome", "Produto", "NOME", "PRODUTO", "Descrição do Produto", "Nome do Produto", "Nome Produto", "DESCRICAO", "Descrição", "Item", "ITEM"],
      description: ["descricao", "descrição", "desc", "Descrição", "Descricao", "DESCRIÇÃO", "Detalhes", "DETALHES", "Observação", "OBS", "Complemento"],
      sku: ["codigo", "código", "cod", "ref", "referencia", "referência", "Código", "SKU", "COD", "REF", "Codigo", "Referência", "CODIGO", "CÓDIGO", "Cod Produto", "Código Produto", "ID", "id", "Cód", "Cód.", "Cod."],
      unit: ["unidade", "un", "Unidade", "UNIDADE", "UN", "Und", "UND", "Und.", "UN.", "Medida", "MEDIDA", "Tipo Unidade"],
      cost_price: ["preco_custo", "preço_custo", "custo", "valor_custo", "Custo", "Preço de Custo", "CUSTO", "Valor Custo", "Preço Custo", "Vl. Custo", "Vl Custo", "Vlr Custo", "Preço Compra", "PRECO CUSTO"],
      sale_price: ["preco_venda", "preço_venda", "venda", "preco", "preço", "valor", "Preço", "Venda", "Preço de Venda", "PREÇO", "VENDA", "Valor Venda", "Preço Venda", "Vl. Venda", "Vl Venda", "Vlr Venda", "Valor", "VALOR", "PRECO VENDA", "Preco"],
      stock_quantity: ["estoque", "quantidade", "qtd", "saldo", "Estoque", "Quantidade", "QTD", "ESTOQUE", "QUANTIDADE", "Saldo", "Qtde", "QTDE", "Qtd.", "Qde", "Qtd Estoque", "Saldo Estoque", "Quant", "QUANT"],
      min_stock: ["estoque_minimo", "minimo", "min", "Estoque Mínimo", "Mínimo", "MIN", "Est. Min", "Est Min", "Estoque Min"],
      category: ["categoria", "grupo", "Categoria", "Grupo", "CATEGORIA", "GRUPO", "Classe", "CLASSE", "Departamento", "DEPARTAMENTO"],
    }
  },
  services: {
    name: "Serviços",
