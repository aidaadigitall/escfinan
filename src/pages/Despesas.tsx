		...
		const Despesas = () => {
		  ...
		  const handleBatchAction = (action: "confirm" | "cancel" | "delete") => {
		    if (action === "delete") {
		      ...
		      const newStatus = action === "confirm" ? "paid" : "pending";
		                  ...
		                  <TableCell>
		                    <DropdownMenu>
		                      ...
		                      <DropdownMenuContent align="end">
		                        ...
		                        <DropdownMenuItem onClick={() => handlePartialPayment(transaction)}><Wallet className="h-4 w-4 mr-2" /> Pagamento Parcial</DropdownMenuItem>
		                        <DropdownMenuSeparator />
