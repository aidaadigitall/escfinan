-- Migration: cria funções RPC para pipeline_stages
-- Garante que PostgREST enxergue as funções usadas pelo frontend

-- 1) Criar função: listar estágios do usuário logado
...
-- 3) Criar função: atualizar estágio
...
-- 4) Criar função: excluir estágio
...
-- 5) Criar função: reordenar estágios
